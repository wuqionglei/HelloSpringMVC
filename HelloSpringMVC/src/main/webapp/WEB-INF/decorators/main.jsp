...
<link rel="stylesheet" type="text/css"
	href="<%=request.getContextPath()%>/resources/css/left.css" />
<link rel="stylesheet" type="text/css"
	href="<%=request.getContextPath()%>/resources/css/font-awesome.css" />
<link rel="stylesheet" type="text/css"
	href="<%=request.getContextPath()%>/resources/css/jquery-accordion-menu.css" />
<script type="text/javascript"
	src="<%=request.getContextPath()%>/resources/js/jquery-1.6.2.min.js"></script>
<script type="text/javascript"
	src="<%=request.getContextPath()%>/resources/js/jquery.easydrag.handler.beta2.js"></script>
<script type="text/javascript"
	src="<%=request.getContextPath()%>/resources/js/left.js"></script>
<title><decorator:title default="欢迎使用用户管理系统" /></title>
<decorator:head />
<!-- 取出被装饰页面的head标签中的内容(除了head标签本身) -->
</head>
...
<body>
	...
	<c:if test="${not empty loginUser}">
		<%-- 			<a href="<%=request.getContextPath() %>/user/add">用户添加</a>
			...
			<input type="button" class="normal" value="退出系统"
	...
	<div id="jquery-accordion-menu" class='box'
		style="display: inline; float: left;">
		<div class="other_bar">
			<ul class="menu">
				<li>
					<h1 class="Left_Bar_title">
						<i class="fa fa-heart"></i> <span>用户管理</span>
					</h1>
					<ul>
						<li><p>
								<a href="<%=request.getContextPath() %>/user/add">用户添加</a>
				...
				<li>
					<h1 class="Left_Bar_title">
						<i class="fa fa-truck"></i> <span>文章分类管理</span>
					</h1>
					<ul>
				...
				<li>
					<h1 class="Left_Bar_title">
						<i class="fa fa-group"></i> <span>文章管理</span>
					</h1>
					<ul>
						<li><p>
								<a href="<%=request.getContextPath() %>/article/add">文章添加</a>
							</p></li>
						<li><p>
								<a href="<%=request.getContextPath() %>/article/articles">文章列表</a>
							</p></li>
				...
				<li>
					<h1 class="Left_Bar_title">
						<i class="fa fa-desktop"></i> <span>密码修改</span>
					</h1>
					<ul>
				...
				<li>
					<h1 class="Left_Bar_title">
						<i class="fa fa-shopping-cart"></i> <span>经营管理</span>
					</h1>
					<ul>
	...
	<div align="right" style="display: inline; float: left;">
		<decorator:body />
	</div>
	<!-- 取出被装饰页面的body标签中的内容 -->
	<div align="center"
		style="width: 100%; border-top: 1px solid; float: left; margin-top: 10px;">
		CopyRight@2012-2015<br /> 用户管理系统
	</div>
